...
> [!IMPORTANT]  
> Make sure you use the Kubernetes version that matches your existing OKE cluster. The second command below has version 1.29 as an example, change it accordingly.
