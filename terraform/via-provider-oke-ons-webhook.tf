...
resource "helm_release" "oke-ons-webhook" {
  count      = alltrue([var.install_monitoring, var.setup_alerting, var.install_node_problem_detector_kube_prometheus_stack, var.install_grafana, local.deploy_from_local || local.deploy_from_orm]) ? 1 : 0
