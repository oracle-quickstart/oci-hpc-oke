...
output "stack_version" { value = "v26.8.0" }
...
output "lustre_subnet_id" { value = lookup(module.oke.subnet_ids, "lustre", null) }
output "lustre_nsg_id" { value = lookup(module.oke.custom_nsg_ids, "lustre", null) }
